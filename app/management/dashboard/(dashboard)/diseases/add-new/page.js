  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      const res = await Axios.post(
        `${Baseurl}/diseases/create-disease`,
        data,
        {
          authenticated: true,
        }
      ...
      setLoading(false);
      navigate.replace("/management/dashboard/diseases");
    } catch (error) {
      toast.error(
        data.response.data.message ||
          "An error occurred while creating Disease"
      );
      setLoading(false);
    }
  };
        ...
        <div>
          ...
          <Breadcrumb>
            ...
            <Link
              ...
              href="/management/dashboard/diseases"
            >
              / Disease
            </Link>
